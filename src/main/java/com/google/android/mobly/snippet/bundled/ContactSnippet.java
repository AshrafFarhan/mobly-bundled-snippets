...
public class ContactSnippet implements Snippet {
    ...
    @Rpc(
            description =
                    "Add a contact with a given email address to a Google account on the device.")
    public void contactAddToGoogleAccountByEmail(
        ...
        contentProviderOperations.add(
                ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI)
                        ...
                        .withValue(
                                ContactsContract.CommonDataKinds.Email.ADDRESS, contactEmailAddress)
                        .withValue(
        ...
        contentProviderOperations.add(
                ContentProviderOperation.newDelete(
                                ContentUris.withAppendedId(
                                        ContactsContract.RawContacts.CONTENT_URI, contactId))
                        .build());
